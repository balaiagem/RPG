...
namespace
{
    ...
    const FAHClassSheet GClasses[] =
    {
        ...
        },
        {
            ...
            10,14,5,8,3,3,0,7,false, EAHWeaponKind::Bow,TEXT("Attack"),FLinearColor(.45f,.65f,.6f,1),2400,6,3,TEXT("Arco curto"), 1, 0
        ...
        },
        {
            ...
            12,15,5,6,3,3,0,8,true, EAHWeaponKind::Bow,TEXT("Attack"),FLinearColor(.25f,.7f,.3f,1),3600,8,3,TEXT("Arco longo"), 2, 2
